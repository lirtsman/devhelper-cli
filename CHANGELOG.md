...
* Remove sudo command from Makefile build process to streamline installation steps. (4f71cd3)
* tw config (f442696)
* tw command added (ec787da)
* Update CHANGELOG.md for v0.4.0 (702aef6)
