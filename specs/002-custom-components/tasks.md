...
- [x] T022 [P] [US1] Write test for minimal component deployment in internal/kindenv/customcomponent_test.go
...
- [x] T027 [US1] Implement deployCustomComponents() function in internal/kindenv/customcomponent.go
